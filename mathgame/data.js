...
window.GEO_DATA = {
  countries: [
    ...
    ["Yangi Zelandiya",      "Velllington",     "Okeaniya",         "1907", "🇳🇿"],
...
window.HISTORY_DATA = {
  questions: [
    ...
    {q:"Shavkat Mirziyoyev 'Yangi O'zbekiston' konsepsiyasini qachon e'lon qildi?",
     o:["2017 yilda","2020 yilda","2022 yilda","2016 yilda"],c:2},
...
window.ENGLISH_DATA = {
  categories: {
    ...
    taom: [
      ...
      ["qand","sugar"],
      ["tuz","salt"],
      ["qalampir (ziravorˈ)","pepper (spice)"],
      ["non tekis","flatbread"],
      ["osh (palov)","pilaf"],
      ["sho'rva","soup"],
      ["lag'mon","noodle soup"],
